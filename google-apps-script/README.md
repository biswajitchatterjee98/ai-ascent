# Deploy the AI Ascent Access API

## 1. Create the Google Sheet

1. Go to [Google Sheets](https://sheets.google.com) and create a blank spreadsheet named **AI Ascent Access**.
2. Open **Extensions → Apps Script**.
3. Delete any default code and paste the contents of `Code.gs` from this folder.
4. Save the project (e.g. **Ascent Access API**).
...
2. Add property:
   ...
   - **Value:** `https://biswajitchatterjee98.github.io/ai-ascent/content-manifest.json`
...
Edit `config.js` in the ai-ascent repo:
...
Commit and push. Login, access gates, and the admin panel will call this URL.
