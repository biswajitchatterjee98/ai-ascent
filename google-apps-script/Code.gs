/**
 * AI Ascent — access control API (Google Sheet + Apps Script).
...
var SEED_USERS = [
  ...
  ['learner01', 'Learn@101', 'learner', 'TRUE'],
  ['learner02', 'Learn@102', 'learner', 'TRUE'],
  ['learner03', 'Learn@103', 'learner', 'TRUE'],
  ['trainer', 'Train@2026', 'learner', 'TRUE'],
  ['guest', 'Guest@2026', 'learner', 'TRUE'],
  ['opslead', 'Ops@2026', 'learner', 'TRUE'],
  ['analyst', 'Data@2026', 'learner', 'TRUE'],
  ['hrdesk', 'HR@2026', 'learner', 'TRUE'],
  ['demo', 'Demo@2026', 'learner', 'TRUE']
];

function doGet() {
  return jsonOutput({ ok: true, service: 'ascent-access-api' });
}
...
function setupSheets() {
  ...
  PropertiesService.getScriptProperties().setProperty(
    ...
    PropertiesService.getScriptProperties().getProperty('MANIFEST_URL') ||
      'https://biswajitchatterjee98.github.io/ai-ascent/content-manifest.json'
  );
}
